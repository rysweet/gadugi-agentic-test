...
exports.basicSystemMonitoringExample = basicSystemMonitoringExample;
exports.continuousMonitoringExample = continuousMonitoringExample;
exports.healthReportExample = healthReportExample;
exports.testIntegrationExample = testIntegrationExample;
exports.dockerMonitoringExample = dockerMonitoringExample;
exports.advancedConfigurationExample = advancedConfigurationExample;
exports.runAllExamples = runAllExamples;
const SystemAgent_1 = require("../SystemAgent");
async function basicSystemMonitoringExample() {
    ...
    const agent = (0, SystemAgent_1.createSystemAgent)({
...
async function advancedConfigurationExample() {
    ...
    const agent = (0, SystemAgent_1.createSystemAgent)(advancedConfig);
    try {
        await agent.initialize();
...
//# sourceMappingURL=SystemAgent.example.js.map