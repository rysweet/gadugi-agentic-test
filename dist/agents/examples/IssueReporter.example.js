...
exports.exampleConfig = exampleConfig;
/**
...
exports.exampleFailure = exampleFailure;
/**
 * Basic usage example
 */
async function basicUsageExample() {
    ...
    try {
        ...
        const issueReporter = (0, IssueReporter_1.createIssueReporter)(exampleConfig);
...
async function advancedFeaturesExample() {
    console.log('\n=== Advanced Features Example ===\n');
    try {
        const issueReporter = (0, IssueReporter_1.createIssueReporter)({
            ...exampleConfig,
            enableDeduplication: true,
        ...
        // Attach a screenshot
        try {
            const screenshotUrl = await issueReporter.attachScreenshot(issue.issueNumber, 'screenshots/build-error-1.png');
 ...
 */
async function pullRequestExample() {
    console.log('\n=== Pull Request Creation Example ===\n');
    try {
        const issueReporter = (0, IssueReporter_1.createIssueReporter)(exampleConfig);
        await issueReporter.initialize();
...
Fixes #${123} // Issue number would come from createIssue result`,
        ...
        console.error('❌ Error in pull request example:', error.message);
    }
}
/**
    ...
    try {
        ...
        for (const failure of multipleFailures) {
            try {
                ...
                console.error(`❌ Failed to create issue for ${failure.scenarioId}:`, error.message);
            }
        }
...
//# sourceMappingURL=IssueReporter.example.js.map