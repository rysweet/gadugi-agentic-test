...
exports.basicPriorityAnalysisExample = basicPriorityAnalysisExample;
exports.customRulesExample = customRulesExample;
exports.flakyTestDetectionExample = flakyTestDetectionExample;
exports.patternAnalysisExample = patternAnalysisExample;
exports.comprehensiveReportExample = comprehensiveReportExample;
exports.realTimeMonitoringExample = realTimeMonitoringExample;
exports.runAllExamples = runAllExamples;
const PriorityAgent_1 = require("../PriorityAgent");
const TestModels_1 = require("../../models/TestModels");
const logger_1 = require("../../utils/logger");
/**
 * Example 1: Basic Priority Agent Usage
 */
async function basicPriorityAnalysisExample() {
    console.log('=== Basic Priority Analysis Example ===');
    // Create agent with default configuration
    const agent = (0, PriorityAgent_1.createPriorityAgent)();
    try {
...
async function customRulesExample() {
    ...
    const agent = (0, PriorityAgent_1.createPriorityAgent)(config);
    try {
        await agent.initialize();
 ...
 */
async function flakyTestDetectionExample() {
        ...
        scenarios.forEach(scenarioId => {
            for (let i = 0; i < 20; i++) {
                ...
                if (scenarioId === 'very-flaky-test') {
                    status = i % 2 === 0 ? TestModels_1.TestStatus.PASSED : TestModels_1.TestStatus.FAILED;
                }
                testResults.push({
                    scenarioId,
                    status,
...
async function comprehensiveReportExample() {
    ...
    try {
        ...
        scenarios.set('critical-login', {
            ...
            priority: TestModels_1.Priority.CRITICAL,
        ...
        for (let i = 0; i < 10; i++) {
            testResults.push({
                scenarioId: 'critical-login',
                status: i < 8 ? TestModels_1.TestStatus.PASSED : TestModels_1.TestStatus.FAILED, // Recent failures
...
async function realTimeMonitoringExample() {
    ...
    try {
        ...
        for (const failure of newFailures) {
            ...
            console.log(`   Priority: ${assignment.priority}`);
            console.log(`   Impact Score: ${assignment.impactScore.toFixed(1)}`);
            if (assignment.priority === TestModels_1.Priority.CRITICAL) {
...
//# sourceMappingURL=PriorityAgent.example.js.map